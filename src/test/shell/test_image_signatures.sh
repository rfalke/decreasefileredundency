...
do
    ...
    diff -u src/test/shell/expected_image_output_${sig}_csv $TMPDIR/actual_image_output
    ...
    diff -u src/test/shell/expected_image_output_${sig}_json $TMPDIR/actual_image_output
